...
const SearchSuggestions = ({
    ...
    return (
        <div className="absolute bg-slate-500 top-full left-0 right-0 z-50 bg-surface border border-border rounded-b-lg shadow-elevation-2 max-h-80 overflow-y-auto">
