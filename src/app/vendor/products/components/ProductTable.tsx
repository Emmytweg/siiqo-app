        ...
        <table className="w-full">
          <thead className="border-b bg-muted/50 border-border">
            <tr>
              ...
              <th className="px-4 py-3 text-sm font-medium text-left">Stock</th>
              <th className="px-4 py-3 text-sm font-medium text-left">Status</th>
              <th className="px-4 py-3 text-sm font-medium text-left">Created</th>
                  ...
                  <td className="px-4 py-4">
                    {editingCell === `${product.id}-price` ? (
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            saveQuickEdit(String(product.id), "price")
                          }
                        >
                          <Icon name="Check" size={16} />
                        </button>
                        <button onClick={cancelQuickEdit}>
                          <Icon name="X" size={16} />
                        </button>
                      </div>
                    ) : (
